        ...
        <div class="chat-box">
            <div class="chat incoming">
                <div class="details start">
                    <p>Hey there, I'm Bolt the Zoom virtual assistant ⚡️</p>
                </div>
            </div>
            <div class="chat incoming">
                <div class="details start">
                    <p>I operate best when asked short, direct questions</p>
                </div>
            </div>
            <div class="chat incoming">
                <img src="{{ asset('/front') }}/images/avatar-01.jpg" alt="" class="rounded-circle">
            ...
            <div class="chat suggestion">
                <div class="details">
                    <button id="sugest">I can't join my meeting</button>
                </div>
            </div>
        </div>
        <form action="#" class="typing-area">
            <input id="data" type="text" placeholder="Type a message here...">
