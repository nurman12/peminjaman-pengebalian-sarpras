    ...
    <tbody>
        ...
        <tr>
            ...
            <th width="120px !importent">
                ...
                <a id="delete" data-id="{{ $data->id }}" data-nama="{{$data->sarpras->nama}}" style="width: 34px;" class="mt-xs btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash-o"></i></i></a>
            </th>
        </tr>
        @endforeach
    </tbody>
