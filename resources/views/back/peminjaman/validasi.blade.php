                    ...
                    <div class="row mb-xl">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="flex-w flex-t">
                                ...
                                <div class="size-209">
                                    <span class="stext-115 cl2">
                                        {{ date('d F Y H:i', strtotime( $peminjaman->validasi->tanggal_start )) }}
                                    </span>
                                </div>
                                <div class="size-208">
                                    <span class="stext-115 cl2">
                                ...
                                <div class="size-209">
                                    <span class="stext-115 cl2">
                                        {{ date('d F Y H:i', strtotime( $peminjaman->validasi->tanggal_finish )) }}
                                    </span>
                                </div>
                                <div class="size-208">
                                    <span class="stext-115 cl2">
...
<div id="varifikasi" class="zoom-anim-dialog modal-block modal-block-lg modal-block-primary mfp-hide">
    <section class="panel">
        ...
        <footer class="panel-footer">
            <div class="row">
                <div class="col-md-12 text-right">
                    <button class="btn btn-primary modal-dismiss" data-pengem="{{$peminjaman->id}}" id="modal-confirm">Confirm</button>
